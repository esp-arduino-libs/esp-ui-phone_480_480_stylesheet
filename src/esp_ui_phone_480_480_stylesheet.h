...
#define ESP_UI_PHONE_480_480_DARK_HOME_DATA()                                     \
    {                                                                             \
        .status_bar = {                                                           \
            .data = ESP_UI_PHONE_480_480_DARK_STATUS_BAR_DATA(),                  \
            .visual_mode = ESP_UI_STATUS_BAR_VISUAL_MODE_SHOW_FIXED,              \
        },                                                                        \
        .navigation_bar = {                                                       \
            .data = ESP_UI_PHONE_480_480_DARK_NAVIGATION_BAR_DATA(),              \
            .visual_mode = ESP_UI_NAVIGATION_BAR_VISUAL_MODE_SHOW_FIXED,          \
        },                                                                        \
        .app_launcher = {                                                         \
            .data = ESP_UI_PHONE_480_480_DARK_APP_LAUNCHER_DATA(),                \
        },                                                                        \
        .recents_screen = {                                                       \
            .data = ESP_UI_PHONE_480_480_DARK_RECENTS_SCREEN_DATA(),              \
